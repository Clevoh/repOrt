...
function Stats () {
    return (
        <div className="container-fluid">
            <div className="row row-cols-md-2 stats-block">
                <div className="col-sm-4 col-md-3 stud-block">
                ...
                <div className="col-sm-4 col-md-3 teach-block">
                ...
                <div className="col-sm-4 col-md-3 parent-block">
                ...
                <div className="col-sm-4 col-md-3 earning">
